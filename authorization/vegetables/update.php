...
global $conn;
  ...
  if($photo) {
    ...
    $sql = "UPDATE vegetables SET name_eng='$name_eng',name_mm='$name_mm',ingredients_eng='$ingredients_eng',ingredients_mm='$ingredients_mm',about_eng='$about_eng', 
        about_mm ='$about_mm',sub_category = '$sub_category',type = '$type',
        photo='$photo' WHERE id = $id";
  } else {
    $sql = "UPDATE vegetables SET name_eng='$name_eng',name_mm='$name_mm',ingredients_eng='$ingredients_eng',ingredients_mm='$ingredients_mm',about_eng='$about_eng', 
        about_mm ='$about_mm',sub_category = '$sub_category',type = '$type' WHERE id = $id";
  }
