...
global $conn;
    $total = mysqli_query($conn, "SELECT id FROM meat");
    ...
    if(isset($_GET['type'])) {
        ...
        if($type !== 'myanmar' && $type !== 'chinese' && $type !== 'indian')
        {
            ...
            // get all records
            $all_records = get_all_records("meat",$limit,$start);
        } else {
            $all_records = get_all_records_by_type("meat",$type,$limit,$start);
        }
    } else {
        // get all records
        $all_records = get_all_records("meat",$limit,$start);
...
?>
    <div class="with_background">
        <div class="with_background_child_element">
            ...
            <?php                 
                // get latest record
                $latest_record = mysqli_fetch_assoc(get_latest_record("meat"));
                            ...
                            <div class="col-xl-6 col-lg-7 col-md-5 col-sm-12 col-12">
                                ...
                                <p class="intro">
                                    <?php
                                        ...
                                        echo $about_eng;
                                        echo "<br>";
                                        $calculated_points = calculate_ratings($row['id'],"meat");
            ...
            <?php
                // count total records
                if($type == 'all') {
                    $rs_result = total_count("meat");  
                } else {
                    $rs_result = total_count_by_type("meat",$type);
                }
